...
public class Member{
    ...
    @Column(name = "desired_region2_dong", length = 50)
    ...
    @Column(name = "desired_region3_dong", length = 50)
    ...
    public void updatePreferences(
        ...
        if (desiredRegion2Dong != null) this.desiredRegion2Dong = desiredRegion2Dong;
        ...
        if (desiredRegion3Dong != null) this.desiredRegion3Dong = desiredRegion3Dong;
